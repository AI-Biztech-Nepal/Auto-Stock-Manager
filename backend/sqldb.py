...
TABLES = {
    "users": {"columns": {"id", "username", "password_hash", "name", "role", "created_at"}},
    "vendors": {"columns": {"id", "name", "phone", "address", "notes", "vendor_type", "created_at"}},
    "customers": {"columns": {"id", "name", "contact_number", "address", "occupation", "budget_min",
                               "budget_max", "interested_brands", "notes", "created_at", "last_purchase_date"}},
    "team_members": {"columns": {"id", "name", "role", "contact", "specialization", "commission_rate",
                                  "joining_date", "is_active", "created_at"}, "bool_cols": {"is_active"}},
    "partners": {"columns": {"id", "name", "capital_contribution", "stake_percentage", "contact", "created_at"}},
    "vehicles": {"columns": {"id", "brand", "model", "variant", "year", "engine_cc", "fuel_type", "vehicle_type",
    ...
    "sales": {"columns": {"id", "vehicle_id", "customer_id", "sale_price", "extra_expenses", "expenses_total",
                           "total_amount", "payment_method", "paid_cash", "paid_bank", "due_amount", "due_date",
                           "payment_status", "payment_history", "sale_date", "notes", "created_by", "created_at",
                           "updated_by", "updated_at", "returned", "returned_at", "returned_status",
                           "refund_amount", "retained_amount", "return_notes"},
              "bool_cols": {"returned"}, "json_cols": {"extra_expenses", "payment_history"}},
    "spare_parts": {"columns": {"id", "name", "category", "brand_compatibility", "part_number", "quantity",
    ...
    "kit_components": {"columns": {"id", "kit_part_id", "component_part_id", "qty_per_kit", "created_by",
                                    "created_at"}},
    "part_transactions": {"columns": {"id", "part_id", "part_name", "type", "quantity", "reason", "date",
                                       "job_id", "notes", "created_by", "created_at"}},
    "job_cards": {"columns": {"id", "vehicle_id", "is_external", "vehicle_brand", "vehicle_model", "vehicle_year",
    ...
    "expenses": {"columns": {"id", "vehicle_id", "category", "amount", "description", "date", "added_by",
                              "created_at"}},
    "vendor_payments": {"columns": {"id", "vendor_id", "amount", "vehicle_id", "payment_date", "notes",
                                     "recorded_by", "created_at"}},
    "emi_records": {"columns": {"id", "customer_id", "vehicle_id", "loan_amount", "down_payment", "interest_rate",
    ...
    "emi_payments": {"columns": {"id", "emi_id", "amount", "payment_date", "notes", "recorded_by", "created_at"}},
    "vehicle_photos": {"columns": {"id", "vehicle_id", "filename", "content_type", "data", "uploaded_at", "size"}},
    "legal_documents": {"columns": {"id", "vehicle_id", "filename", "content_type", "data", "doc_type",
                                     "original_name", "uploaded_at", "size"}},
    "leads": {"columns": {"id", "type", "name", "phone", "message", "images", "requested_service", "vehicle_type",
                           "preferred_date", "status", "created_at"}, "json_cols": {"images"}},
    "settings": {"columns": {"id", "logo_url", "business_name", "contact_phone", "contact_email", "address",
